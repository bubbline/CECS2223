...
void MyTime::setSeconds(int seconds) // service
{
	this->seconds = seconds;
}

void MyTime::setMinutes(int minutes) //service
{
	this->minutes = minutes;
}

void MyTime::setHour(int hour) //service
{
	this->hour = hour;
}
...
void MyTime::askHour()
{
	...
	cout << endl << "Is AM (pres 1; otherwise PM): ";
	cin >> d;
	if (d != '1')
		this->setPM();
}
