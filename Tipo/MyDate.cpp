...
{
	return((this->year % 400 == 0) || (this->year % 100 != 0 &&
		this->year % 4 == 0));
}
...
void MyDate::askDay()
{
	...
	valid30 = ((this->month != 2) && ((this->month % 2 == 0 && this->month <= 6) ||
		(this->month % 2 != 0 && this->month >= 9)) && (this->day > 0
			&& this->day <= 30));

	valid31 = ((this->month != 2) && ((this->month % 2 == 0 && this->month >= 8) ||
		(this->month % 2 != 0 && this->month <= 7)) && (this->day > 0
			&& this->day <= 31));
...
{
	return(this->day == aDate.day && this->month == aDate.month &&
		this->year == aDate.year);
}
...
bool MyDate::operator>(const MyDate & aDate) const
{
	return((this->year > aDate.year) || (this->year == aDate.year && this->month > aDate.month)
		|| (this->year == aDate.year && this->month
			== aDate.month && this->day > aDate.day));
}
